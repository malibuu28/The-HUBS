...
{weeklyFocus&&(<div className="mt-3 bg-cream/50 rounded-xl px-3 py-2 border border-sand/20"><p className="text-xs text-warm">Weekly Focus</p><p className="text-sm text-deeper">{weeklyFocus}</p></div>)}
</div>
<CalendarWidget/>
<PushNotifications/>
<SeventyFiveHoly/>
