...
<div><h2 className="text-lg font-semibold text-deeper">Learning & Trading 📚</h2><p className="text-sm text-warm">Topics · Trade Journal · Roadmap</p></div>
</div>
...
<div><h3 className="text-base font-semibold text-deeper">{activeTopic.title}</h3><p className="text-xs text-warm">{activeTopic.category}</p></div>
</div>
