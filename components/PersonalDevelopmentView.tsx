...
const[activeTab,setActiveTab]=useState<'books'|'bucket'|'goals'|'vision'|'learning'>('books')
...
<p className="text-xs text-warm mb-4">Books · Bucket List · Goals · Vision · Learning</p>
<div className="flex gap-1 mb-4 overflow-x-auto pb-1">
{(['books','bucket','goals','vision','learning'] as const).map(tab=>(
